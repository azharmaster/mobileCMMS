...
import 'package:pakar_cmms/pages/maintenance_update/update_unscheduled.dart';
import 'package:pakar_cmms/models/task_detail_obj.dart';
import 'package:http/http.dart' as http;
import '../../api/api_connection.dart';
import '../../models/scheduled_wo_object.dart';
import '../../models/img_object.dart';



class UnscheduledCompleted extends StatefulWidget {
  final assetNo, workOrderNo, taskType;
  const UnscheduledCompleted ({Key? mykey, this.assetNo, this.workOrderNo, this.taskType}): super(key: mykey);

  @override
  State<UnscheduledCompleted> createState() => _UnscheduledCompletedState();
}

class _UnscheduledCompletedState extends State<UnscheduledCompleted> {
  ...
  Future _getTaskDetail() async{
    ...
    var response = await http.post(Uri.parse(API.getAssetDetail),
      ...
      debugPrint("Asset Detail Retrieved");
      setState(() {
        ...
        Padding(
          ...
          child: ElevatedButton(
            onPressed: () => Navigator.push(context, MaterialPageRoute(
              builder: (context) => UpdateUnscheduled(
                assetNo : widget.assetNo,
                workOrderNo: widget.workOrderNo,))),
